    ...
    const industryTemplates = [
      {
        ...
        terminology: { leads: "Enquiries", deals: "Work Orders", invoices: "Running Account Bills", products: "Materials", projects: "Sites" },
        sortOrder: 1,
      },
      {
        industry: "Construction & Engineering",
        ...
        terminology: { leads: "Enquiries", deals: "Consultancy Contracts", invoices: "Fee Notes", projects: "Assignments" },
        sortOrder: 2,
      },
      {
