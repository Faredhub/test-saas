...
const baseCategories: NavCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Table Manager", href: "/sales/table-manager", icon: TabletSmartphone },
      { name: "Token/Points", href: "/sales/token-points", icon: Star },
      { name: "Captain", href: "/sales/captain", icon: Bike },
      { name: "POS Integrations", href: "/sales/pos-integrations", icon: Smartphone },
      { name: "Simulation", href: "/sales/simulation", icon: Calculator },
    ],
  },
  {
    key: "Site Store",
    ...
    items: [
      ...
      { name: "Products", href: "/inventory/products", icon: ShoppingBag },
      { name: "Product Variants", href: "/inventory/variants", icon: Layers },
      { name: "Lots / Serial Numbers", href: "/inventory/lots", icon: QrCode },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Job Portals", href: "/hrm/recruitment/portals", icon: Globe },
      // { name: "Job Syndication", href: "/hrm/recruitment/syndication", icon: Share2 },
      ...
      { name: "Trip Requests", href: "/hrm/trips", icon: Route },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Site Store (eCommerce)", href: "/website/store", icon: ShoppingBag },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "HR Report", href: "/organization/reports/hr", icon: Users },
      { name: "Asset Report", href: "/organization/reports/assets", icon: Wrench },
      { name: "Vendor Report", href: "/organization/reports/vendor", icon: Building2 },
  ...
  },
  {
    ...
    items: [
      { name: "Overview", href: "/civil", icon: HardHat },
      { name: "Geotechnical", href: "/civil/geotechnical", icon: Mountain },
      { name: "Survey", href: "/civil/survey", icon: Compass },
      { name: "Design", href: "/civil/design", icon: Ruler },
      { name: "Estimation", href: "/civil/estimation", icon: Calculator },
    ],
  },
  {
    key: "settings",
...
const routeResourceMap: Record<string, string[]> = {
  ...
  "/sales/table-manager": ["waiter-calls", "sales"],
  "/sales/token-points": ["sales"],
  "/sales/captain": ["sales"],
  "/sales/pos-integrations": ["sales"],
  ...
  "/marketing/sms": ["campaigns", "marketing"],
  "/marketing/whatsapp": ["campaigns", "marketing"],
  ...
  "/profile": ["*"],
  "/civil": ["civil"],
  "/civil/geotechnical": ["civil"],
  "/civil/survey": ["civil"],
  "/civil/design": ["civil"],
  "/civil/estimation": ["civil"],
};
